...
declare class Client extends EventEmitter {
     ...
     */
    static generateTemplateGuild(o?: {
        name: string;
        icon: string;
    }): Object;
    /**
...
declare class ApplicationCommandManager extends Base {
     ...
     */
    _add(commands: string | ApplicationCommand, guild?: string | undefined, options?: {
        cache?: boolean | undefined;
        force?: boolean | undefined;
    } | undefined): ApplicationCommand;
    /**
     ...
     */
    fetch(command: string | ApplicationCommand, options: {
        cache: boolean;
        force: boolean;
        guild: string;
...
declare class ApplicationCommandPermissionManager extends Base {
     ...
     */
    _add(commands: string | ApplicationCommand, guildId?: string | undefined, options?: {
        cache?: boolean | undefined;
        force?: boolean | undefined;
    } | undefined): ApplicationCommandPermission;
    /**
     ...
     */
    fetch(commands: string | object, options?: {
        cache?: boolean | undefined;
        force?: boolean | undefined;
        guild?: string | Guild;
    } | undefined): Promise<Cache>;
    /**
     ...
     * @throws {RangeError} - If the guild ID is not provided.
     */
    _fetchId(commands: string | {
        commandId: string;
    }, cache?: boolean | undefined, force?: boolean | undefined, guild?: string | {
        id: string;
...
declare class AutoModManager extends Base {
     ...
     */
    _add(rules: string | Rule, guildId?: string | undefined, options?: {
        cache?: boolean | undefined;
        force?: boolean | undefined;
    } | undefined): Rule | null;
    /**
     ...
     */
    fetch(rule: string | object, options?: {
        cache?: boolean | undefined;
        force?: boolean | undefined;
     ...
     */
    _fetchId(rule: string | {
        id: string;
    }, cache?: boolean | undefined, force?: boolean | undefined): Promise<any>;
    /**
     ...
     */
    edit(rule: string | Rule, options?: {
        reason?: string | undefined;
    } | undefined): Promise<Rule>;
    /**
...
declare class BaseThreadManager extends Base {
     ...
     */
    _add(threads: string | ThreadChannelResolvable, guildId?: any, options?: {
        cache?: boolean | undefined;
        force?: boolean | undefined;
    } | undefined): ThreadChannel | null;
    /**
     ...
     */
    create(message: string | object, options: {
        reason?: string | undefined;
        name?: string | undefined;
        type?: string | number | undefined;
     ...
     */
    fetchArchivedThread(options?: {
        before?: Date | undefined;
        limit?: number | undefined;
        public?: boolean | undefined;
    } | undefined): Promise<FetchedThreads>;
    /**
...
declare class ChannelManager extends Base {
     ...
     */
    _add(channels: string | Channel, guildId?: string | undefined, options?: {
        cache?: boolean | undefined;
        force?: boolean | undefined;
    } | undefined): Channel;
    /**
     ...
     */
    fetch(channel: string | object, options?: {
        cache?: boolean | undefined;
        force?: boolean | undefined;
    } | undefined): Promise<object>;
    /**
     ...
     */
    edit(channel: string | Channel, options?: {
        reason?: string | undefined;
    } | undefined): Promise<Channel>;
    /**
     * Deletes a channel.
     ...
     */
    createInvite(channel: string | Channel, options?: {
        reason?: string | undefined;
    } | undefined): Promise<Invite>;
    /**
     ...
     */
    follow(news: string | NewsChannel, options?: {
        reason?: string | undefined;
...
declare class EmojiManager extends Base {
     ...
     */
    _add(emojis: string | EmojiResolvable, guildId?: string | undefined, options?: {
        cache?: boolean | undefined;
        force?: boolean | undefined;
    } | undefined): Emoji | null;
    /**
     ...
     */
    edit(emoji: string | Emoji, options?: {
        reason?: string | undefined;
    } | undefined): Promise<Emoji>;
    /**
     ...
     */
    fetch(emoji: string | object, options?: {
        cache?: boolean | undefined;
        force?: boolean | undefined;
    } | undefined): Promise<EmojiCache>;
    /**
...
declare class GuildBanManager extends Base {
     ...
     */
    _add(bans: string | GuildBan, guildId?: string | undefined, options?: {
        cache?: boolean | undefined;
        force?: boolean | undefined;
    } | undefined): GuildBan | null;
    /**
     ...
     */
    create(user: string | User, options?: {
        reason?: string | undefined;
    } | undefined): Promise<GuildBan>;
    /**
     ...
     */
    fetch(ban: string | object, options: {
        cache: boolean;
        force: boolean;
    }): Promise<object>;
    /**
...
declare class GuildIntegrationManager extends Base {
     ...
     */
    _add(integrations: string | Integration, guildId?: string | undefined, options?: {
        cache?: boolean | undefined;
        force?: boolean | undefined;
    } | undefined): Integration | null;
    /**
    ...
    fetch(options?: {
        cache?: boolean | undefined;
        force?: boolean | undefined;
    } | undefined, guild?: string | Guild): Promise<Cache>;
    /**
    ...
    delete(options: {
        guild: string;
        integration: string;
    } | undefined, reason: string): Promise<any>;
    /**
     * Getter method for the cache property.
     * @returns The Collection object representing the cache.
     */
...
declare class GuildInviteManager extends Base {
     ...
     */
    _add(invites: string | Invite, guild?: any, options?: {
        cache?: boolean | undefined;
        force?: boolean | undefined;
    } | undefined): Invite | null;
    /**
    ...
    fetch(options?: {
        cache?: boolean | undefined;
        force?: boolean | undefined;
    } | undefined): Promise<CacheConstructor>;
    /**
...
declare class GuildManager extends Base {
     ...
     */
    _add(guilds: string | Guild, options?: {
        cache?: boolean | undefined;
        force?: boolean | undefined;
    } | undefined): Guild | null;
    /**
     ...
     */
    fetch(guild: string | object, options: {
        cache: boolean;
        force: boolean;
        before: string;
        after: string;
     ...
     */
    _fetchId(guild: string | Guild, options?: {
        cache?: boolean | undefined;
        force?: boolean | undefined;
        withCounts?: boolean | undefined;
    } | undefined): Promise<string>;
     ...
     */
    edit(guilds: string | Guild, options?: {
        reason?: string | undefined;
    } | undefined): Promise<Guild>;
    /**
     ...
     */
    modifyMFALevel(guild: string | Guild, options?: {
        reason?: string | undefined;
...
declare class GuildMemberManager extends Base {
     ...
     */
    _add(members: string | GuildMember, guildId?: string | undefined, options?: {
        cache?: boolean | undefined;
        force?: boolean | undefined;
    } | undefined): GuildMember | null;
    /**
     ...
     */
    fetch(member: string | object, options: {
        cache?: boolean | undefined;
        force?: boolean | undefined;
     ...
     */
    edit(member: string | GuildMember, options?: {
        reason?: string | undefined;
    } | undefined): Promise<GuildMember>;
    /**
     ...
     */
    _fetchId(member: string | Object, options?: {
        force?: boolean | undefined;
        cache?: boolean | undefined;
    } | undefined): Promise<Object>;
    /**
...
declare class GuildMemberRoleManager extends RoleManager {
     ...
     */
    static transformRole(role?: RaidenCol | string | {
        id?: string;
    }): string[];
    /**
     * Constructs a new instance of the class.
...
declare class GuildMemberVerificationManager extends Base {
    ...
    } | undefined): Promise<GuildMemberVerification>;
    /**
...
declare class GuildTemplateManager extends Base {
     ...
     */
    _add(templates: string | {
        code: string;
    }, options?: {
        cache?: boolean | undefined;
        force?: boolean | undefined;
    } | undefined): GuildTemplate | null;
    /**
...
declare class GuildWidgetManager extends Base {
    ...
    edit(options?: {
        reason?: string | undefined;
    } | undefined): Promise<GuildWidgetSettings>;
}
import Base = require("../Base/base");
...
declare class MessageManager extends Base {
     ...
     */
    _add(messages: string | Message, guildId?: string | undefined, channelId?: string | undefined, options?: {
        cache?: boolean | undefined;
        force?: boolean | undefined;
    } | undefined): any;
    /**
     ...
     * @throws {RangeError}
     */
    bulkDelete(channel?: string | Channel, message?: number | Message[] | Map<string, Message> | undefined, reason?: string | undefined): Promise<Array<[string, Message]>>;
    /**
     ...
     */
    fetch(message: string | object, options?: {
        cache?: boolean | undefined;
        force?: boolean | undefined;
    } | undefined): Promise<Message | Map<string, Message>>;
    /**
...
declare class PermissionOverwriteManager extends Base {
     ...
     */
    edit(userOrRole: string | User | Role, options?: Object | undefined, overwriteOptions?: {
        reason?: string | undefined;
        type?: string | undefined;
    } | undefined): Promise<Channel>;
    /**
...
declare class PresenceManager extends Base {
     ...
     */
    _add(presences: string | Presence, options?: {
        cache?: boolean | undefined;
        force?: boolean | undefined;
    } | undefined): Presence | null;
    /**
     * Getter method for the cache property.
     * @returns The Collection object representing the cache.
     */
...
declare class ReactionUserManager extends Base {
     ...
     */
    _add(users: User | string, options?: {
        cache?: boolean | undefined;
        force?: boolean | undefined;
    } | undefined): User | null;
    /**
    ...
    fetch(options: {
        cache?: boolean | undefined;
        force?: boolean | undefined;
    }): Promise<Map<string, ReactionUser>>;
    /**
...
declare class RoleManager extends Base {
     ...
     */
    _add(roles: string | Role, guildId?: string | undefined, options?: {
        cache?: boolean | undefined;
        force?: boolean | undefined;
    } | undefined): Role | null;
    /**
     ...
     */
    edit(role: string | Role, options?: {
        reason?: string | undefined;
        position?: number | undefined;
    } | undefined): Promise<Role>;
    /**
...
declare class RolePromptManager extends Base {
     ...
     */
    _add(prompts: string | RolePrompt, guildId?: string | undefined, options?: {
        cache?: boolean | undefined;
        force?: boolean | undefined;
    } | undefined): RolePrompt | null;
    /**
...
declare class ScheduledEventManager extends Base {
     ...
     */
    _add(events: string | GuildScheduledEvent, guildId?: string | undefined, options?: {
        cache?: boolean | undefined;
        force?: boolean | undefined;
    } | undefined): GuildScheduledEvent | null;
    /**
     ...
     */
    edit(event: string | Object, options?: {
        reason?: string | undefined;
    } | undefined): Promise<Object>;
    /**
...
declare class StageInstanceManager extends Base {
     ...
     */
    _add(stageInstances: string | StageInstance, guildId?: string | undefined, options?: {
        cache?: boolean | undefined;
        force?: boolean | undefined;
    } | undefined): StageInstance | null;
    /**
     ...
     */
    fetch(channel: string | Channel, options?: {
        cache?: boolean | undefined;
        force?: boolean | undefined;
    } | undefined): Promise<StageInstance>;
    /**
...
declare class StickerManager extends Base {
     ...
     */
    _add(stickers: string | Sticker, guildId?: string | undefined, options?: {
        cache?: boolean | undefined;
        force?: boolean | undefined;
    } | undefined): Sticker | null;
    /**
     ...
     */
    fetch(sticker: string | object, options?: {
        cache?: boolean | undefined;
        force?: boolean | undefined;
     ...
     */
    edit(sticker: string | Sticker, options?: {
        reason?: string | undefined;
    } | undefined): Promise<Sticker>;
    /**
...
declare class ThreadMemberManager extends Base {
    ...
    _add(members: string | {
        user_id: string;
    }, guildId?: string | undefined, threadId?: string | undefined, options?: {
        cache?: boolean | undefined;
        force?: boolean | undefined;
    } | undefined): any;
    /**
     ...
     */
    fetch(user: string | object, options?: {
        cache?: boolean | undefined;
        force?: boolean | undefined;
    } | undefined): Promise<any>;
    /**
...
declare class UserManager extends Base {
     ...
     */
    fetch(user: string | User, options?: {
        cache?: boolean | undefined;
        force?: boolean | undefined;
...
declare class VoiceStateManager extends Base {
     ...
     */
    _add(voiceStates: string | VoiceState, guildId?: string | undefined, options?: {
        cache?: boolean | undefined;
        force?: boolean | undefined;
    } | undefined): VoiceState | null;
    /**
     * Getter method for the cache property.
     * @returns The Collection object representing the cache.
     */
...
declare class WelcomeScreenManager extends Base {
    ...
    edit(options?: {
        reason?: string | undefined;
    } | undefined): Promise<WelcomeScreen>;
}
import Base = require("../Base/base");
...
declare class Guild extends Base {
    ...
    fetchAuditLogs(options?: {
        ...
        limit?: number | undefined;
    } | undefined): Promise<GuildAuditLog>;
    /**
...
declare class GuildAutoMod extends Base {
    ...
    setTriggerMetadata(triggerMetadata: {
        ...
        allowList: string[];
    }, reason?: string | undefined): Promise<GuildAutoMod>;
    /**
...
declare class WebhookClient extends Base {
    ...
    } | undefined): Promise<Message | undefined>;
    /**
...
declare class DataManager {
     ...
     */
    static resolveFile(file: Buffer | MessageAttachment | {
        filename: string;
        file: string;
    }): Promise<Buffer | null>;
}
