    ...
    _patch(data) {
        ...
        for(const emojis of packet.emojis) {
            ...
            if(cachedEmoji) {
                ...
                if(!cachedEmoji.equals(emojis)) this.client.emit("emojiUpdate", this.client.emojis._add(emojis), this.client.emojis._add(emojis, packet.guild_id, { cache: true, force: true }))
            } else {
