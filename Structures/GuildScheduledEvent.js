...
class GuildScheduledEvent extends Base {
  constructor(data = {}, guildId, client) {
    ...
    this.scheduledStart = data.scheduled_start_time
      ? new Date(data.scheduled_start_time)
      : null;
    this.scheduledStartTimestamp = this.scheduledStart?.getTime() ?? null;
    this.scheduledEnd = data.scheduled_end_time
      ? new Date(data.scheduled_end_time)
      : null;
    ...
    this.status =
      (typeof data.status === "number"
        ...
        : data.status) ?? null;
    this.entityType =
      (typeof data.entity_type === "number"
  ...
  coverImageURL(options = {}) {
    ...
    return this.client.cdn.GuildScheduledEventCoverImage(
      this.image,
      options.dynamic,
      options.size,
      options.format,
